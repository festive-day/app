 ...
 *
 * Enhanced version of EtchTypeAsserter with additional functionality for Blocks.
 * Does not modify the original Preprocessor version.
 *
...
use Etch\Preprocessor\Utilities\EtchTypeAsserter as PreprocessorEtchTypeAsserter;

/**
 * Utility class for type checking and conversion operations used in Blocks system.
 *
 * Extends functionality from Preprocessor EtchTypeAsserter with enhanced array parsing.
 */
class EtchTypeAsserter {
	...
	public static function to_string( $value, string $fallback = '' ): string {
		return PreprocessorEtchTypeAsserter::to_string( $value, $fallback );
	}
	...
	public static function to_bool( $value ): bool {
		return PreprocessorEtchTypeAsserter::to_bool( $value );
	}
