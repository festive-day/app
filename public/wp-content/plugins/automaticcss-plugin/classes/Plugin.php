...
class Plugin {
	...
	public function __get( $key ) {
		$allowed_keys = array( 'framework', 'settings_page', 'platforms', 'permissions', 'asset_manager', 'permissions' );
		...
		add_action(
			...
			function () {
				if ( Flag::is_on( 'ENABLE_NEW_ASSET_MANAGEMENT' ) ) {
					Logger::log( sprintf( '%s: activating new asset management', __METHOD__ ) );
